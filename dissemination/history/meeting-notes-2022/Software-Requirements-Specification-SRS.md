...
The purpose of this document is to specify the software requirements of a web-based dependency annotation tool for sentences.

This work entails the development of a new version of the dependency annotation tool [BoAT](https://github.com/boun-tabi/BoAT). The aim of the next version is to improve the user experience of the annotator to support the ease of creating valid annotations and to improve the speed. In addition to improved functionality, this version will be a web application instead of a standalone version.

### Document Scope

This document specifies the software requirements for the annotation tool (independent of version).

### Glossary

The glossary is written [here](https://gitlab.com/furkanakkurt5204/web-annotation-tool/-/wikis/Glossary).
