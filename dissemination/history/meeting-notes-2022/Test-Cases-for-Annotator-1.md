# Test Cases for Annotator 1

# Test Cases

These tests should be under the domain: `http://79.123.177.252/`.
...
|-|-|-|-|-|-|
| 1 | Go to the registration page | URL to go to: `http://79.123.177.252/accounts/register` | The page is loaded.  <br><br> ![image](uploads/44cd15e70ab645e7a19289458288c8ae/image.png) |  |  |
